...
### Data Overview
- **Aggregation:** All gridded data have been aggregated to the national level (Administrative Level 0) using World Bank official boundaries.
- **Sources:** Comprehensive details regarding the original data sources are documented in [`Data_Descriptions.docx`](./Data_Descriptions.docx).
